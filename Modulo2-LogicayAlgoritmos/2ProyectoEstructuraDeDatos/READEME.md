...
* **Filtrado Inverso (`.filter()`):** Para la eliminación de elementos se aplicó un filtro asíncrono que reconstruye la lista omitiendo el elemento seleccionado por el usuario, evitando errores de desajuste de índices.
